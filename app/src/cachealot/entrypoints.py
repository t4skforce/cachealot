...
def entrypoint(interval, threads, entrypoint, query, sitemap, blacklist, samedomain, max_levels, static, connection_timeout, read_timeout, user_agent, headers, elastic_search, kibana):
	try:
		options = Options()
